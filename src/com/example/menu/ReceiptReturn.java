...
public class ReceiptReturn extends JPanel {
	...
	JTextField txtStock=new JTextField(22);
...
//		PanelCenterWestNorth.setBackground(Color.magenta);
	...
	//	PanelCenterCenterNorth.setBackground(Color.orange);
		...
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(2,5,2,5);
		PanelCenterCenterNorth.add(lblSuplyname, c);

		c.gridx=1;
		c.gridy=3;
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(2,5,2,5);
		PanelCenterCenterNorth.add(cmbSuplyname.cmbSuggest, c);

		c.gridx=0;
		c.gridy=4;
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(2,5,2,5);
		PanelCenterCenterNorth.add(lblStock, c);

		c.gridx=1;
		c.gridy=4;
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(2,5,2,5);
		PanelCenterCenterNorth.add(txtStock, c);
